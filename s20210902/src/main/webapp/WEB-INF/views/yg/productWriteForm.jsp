					...
					<div class="shopping__cart__table">
						...
						<form action="productWrite" method="post"
							...
							<table>
								...
								<tr>
									<th>상품코드</th>
									<td><input type="text" name="p_code" required="required"></td>
								</tr>
								<tr>
									<th>상품명</th>
								...
								<tr>
									<th>수량</th>
									<td><input type="text" name="p_qty" required="required"></td>
								</tr>
								<tr>
									<th>가격</th>
									<td><input type="text" name="p_price" required="required"></td>
								</tr>
								<tr>
							...
							<div>
								...
								<input type="button" value="목록" onclick="location.href='productTable'" class="site-btnOrder1">
							</div>
						</form>
					</div>
				</div>
