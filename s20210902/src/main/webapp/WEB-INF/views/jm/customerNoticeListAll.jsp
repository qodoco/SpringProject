	...
	<br>
		...
		<div class="customer_service">
		    <ul>
		    	...
		    	<li class="on"><a href="customerNoticeList">공지사항</a></li>
		    </ul>
		</div>
		...
		<form action="customeNoticeList" method="post" enctype="multipart/form-data" target="myBatisFrame">
			<br>
			<table>
				<tr>
				...
				<td>${notice.n_num }</td>
				<td>　　관리자　　</td>
				<td><a href="customerNoticeDetail?n_num=${notice.n_num}">${notice.n_title}</a></td>
			...
			<Br>
 				<c:if test="${pg.startPage > pg.pageBlock }">
					<a href="customerNoticeList?currentPage=${pg.startPage-pg.pageBlock}">[이전]</a>
				</c:if>
				<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
					<a href="customerNoticeList?currentPage=${i}" class="<c:if test="${pg.currentPage == i }">active</c:if>">${i}</a>
				</c:forEach>
				<c:if test="${pg.endPage < pg.totalPage }">
					<a href="customerNoticeList?currentPage=${pg.startPage+pg.pageBlock}">[다음]</a>
				</c:if>
				<Br>
			</div>
		</form>
