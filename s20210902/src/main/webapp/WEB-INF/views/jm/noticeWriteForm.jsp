    ...
    <section>
     ...
     <h4>공지사항 작성</h4>
       ...
       <div class="shopping__cart__table">
		 <form action="noticeWrite" method="post" enctype="multipart/form-data" target="myBatisFrame">
		 <table>
		 <tr>
		 <th>제목</th>
		 <td><input type="text" name="n_title" required="required"  value=[공지사항] style="width:700px;"></td>
		 </tr>
		 <tr>
  	     <th>내용</th>
			<td>
			<textarea id="InputTextarea" name="n_content" cols="3" rows="1" placeholder="내용을 입력해주세요."
		 ...
		 <tr>
			<th>마감일</th>
			<td>
			<input type="date" name="n_date" required="required" >
			</td>
		</tr>
   		</table>
   		<Br>
