...
<body>
	...
	<section>
		...
		<form action="noticeList" method="post" enctype="multipart/form-data" target="myBatisFrame">
			<br>
			<table>
				<tr>
			...
			<br>
			<input type="button" value="글쓰기" onclick="location.href='noticeWriteForm'" class="primary-btn">
			<div class="product__pagination">
 				<c:if test="${pg.startPage > pg.pageBlock }">
					<a href="noticeList?currentPage=${pg.startPage-pg.pageBlock}">[이전]</a>
				</c:if>
				<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
					<a href="noticeList?currentPage=${i}" class="<c:if test="${pg.currentPage == i }">active</c:if>">${i}</a>
				</c:forEach>
