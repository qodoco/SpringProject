...
<body>
    ...
    <section>
		 ...
		 <form action="noticeUpdate" method="post" enctype="multipart/form-data" target="myBatisFrame">
		   <input type="hidden" name="n_num" value="${notice.n_num }">
		   <table>
		   <tr>
		   <th>제목</th>
		   <td>
		   <input type="text" name="n_title" required="required" value="${notice.n_title }" style="width:700px;"></td>
		   </tr>
		   <tr>
		   <th>내용</th>
		   <td>
		   <input type="text" name="n_content" required="required" value="${notice.n_content }" style="width:700px;height:150px;" >
		   </td>
		   </tr>
		
		   <tr>
		   <th>마감일</th>
		   <td><input type="date" name="n_date" value="${notice.n_date }"></td>
		   </tr>
   		</table>
