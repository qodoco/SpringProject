...
<div class="row d-flex justify-content-center">
		<div class="contact__form">
				...
				<div class="row">
					<div class="col-lg-12">
						<textarea placeholder="Write Review..." rows="5" name="r_content" required="required" onclick="getProCheck(${product.p_code },'${mem_id }')">${review.r_content }</textarea>
						<p><p>
							<input type="hidden" name="r_img" value="${review.r_img}">
							<input type="file" name="file1">
						<p>
							<input type="submit" class="w3-button w3-round w3-black" value="작성 완료">
					</div>
				</div>
			
			<input type="button" value="작성  취소" class="w3-button w3-round w3-black" onclick="history.go(-1);">
		</div>
	</div><p>
	</form>
