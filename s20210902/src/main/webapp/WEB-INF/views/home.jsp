                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix best-seller">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                        	<span onclick="javascript:wishInsert(${proList.p_code });"><img src="img/icon/heart.png" alt="" align="right" ></span>
               ...
               <c:forEach var="proList2" items="${productList2}">
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                        	<span onclick="javascript:wishInsert(${proList2.p_code });"><img src="img/icon/heart.png" alt="" align="right" ></span><!-- </a> -->
