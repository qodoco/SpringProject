...
<body>
    ...
    <section class="breadcrumb-option">
		...
		<table class="orderTable2" style="padding-bottom: 1px;">
			<tr>
				<td width="200px"></td>
				<td width="250px"></td>
				<td align="right">
    ...
    <div class="container">
    <c:set var ="order1ManagerC" value="${order1ListManagerCSearch}"></c:set>
		<table class="orderTable">
			<thead class="orderThead">
				...
				<c:if test="${total > 0 }">
				<c:forEach var="order1ManagerC" items="${order1ListManagerCSearch }">
...
<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
	<a href="order1Search?currentPage=${i}&q=${q1}" class="<c:if test="${pg.currentPage == i }">active</c:if>">${i }</a>
</c:forEach>
