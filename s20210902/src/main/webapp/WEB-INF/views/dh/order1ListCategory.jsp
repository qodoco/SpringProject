...
<body>
	...
	<div class="container">
		<table class="orderTable">
			...
			<c:if test="${total > 0 }">
				<c:forEach var="order1" items="${order1Category }">
...
<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
	<a href="order1ListCategory?currentPage=${i}&o_cancel=${o_cancel1}" class="<c:if test="${pg.currentPage == i }">active</c:if>">${i }</a>
</c:forEach>
