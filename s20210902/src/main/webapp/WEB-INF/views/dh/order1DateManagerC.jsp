    ...
    <section class="breadcrumb-option">
		...
		<table class="orderTable2">
			<tr>
				...
				<td align="right">
				<button type="button" onclick="location.href='order1ListManagerC?currentPage=${pg.currentPage}'" class="site-btnOrder1">최신순</button>
...
<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
	<a href="order1DateManagerC?currentPage=${i}" class="<c:if test="${pg.currentPage == i }">active</c:if>">${i }</a>
</c:forEach>
