...
<body>
   ...
   <section class="breadcrumb-option">
    ...
    <section>
    	...
    	<form action="faqWritePro" method="post" id="faqWriteForm">
    		<div>
    			<input type="text" name="f_title" placeholder="제목을 입력하세요" required="required">
    		</div>
    		<div>
    			<select name="q_mcode">
    				<c:forEach var="faq" items="${faq_mcode }">
    					<option value="${faq.mcode }">${faq.content}</option>
    				</c:forEach>
    			</select>
    			<br>
    			<br>
    		...
    		<div>
				<textarea rows="10" cols="100" name="f_content" placeholder="내용을 입력하세요" required="required"></textarea>
			</div>
			<div class="shopping__cart__table">
				<button type="button" onclick="location.href='adminFaqListAll'" class="primary-btn">목록</button>
