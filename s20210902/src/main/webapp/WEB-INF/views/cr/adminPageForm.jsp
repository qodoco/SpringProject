...
<body>
    ...
    <div class="row">
    	<div class="col-lg-12 col-md-5" >
	    	<div class="customer_service" align="center">
	    	<ul>
	    		<li><a href="mng/list">회원정보 관리</a></li>
	    		<li><a href="productTable">상품 관리</a></li>
	    		<li><a href="order1ListManager">주문내역 관리</a></li>
	    		<li><a href="adminFaqListAll">FAQ</a></li>
	    		<li><a href="qnaAdminList">1:1문의</a></li>
