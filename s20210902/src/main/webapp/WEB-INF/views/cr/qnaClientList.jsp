...
<body>
    ...
    <div class="row">
		...
		<div class="col-lg-12 col-md-5" style="margin-top: 30px;">
    	<div class="shopping__cart__table">
		<form action="qnaWritePro" method="post" enctype="multipart/form-data">
			<table>
				<tr>
			...
			<div class="product__pagination">
				<c:if test="${page.startPage > page.pageBlock }">
					<a href="qnaClientList?&currentPage=${page.startPage - page.pageBlock }">[이전]</a>
				</c:if>
				<c:forEach var="i" begin="${page.startPage }" end="${page.endPage }">
					<a href="qnaClientList?&currentPage=${i }" class="<c:if test="${page.currentPage == i }">active</c:if>">${i }</a>
				</c:forEach>
