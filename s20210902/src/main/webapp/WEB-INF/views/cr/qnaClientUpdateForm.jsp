...
<body>
    ...
    <div class="container">
		...
		<form action="qnaClientUpdatePro" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="q_image" value="${qna.q_image }">
			<table>
				...
				<tr>
					...
					<td>
						...
						<span id="selectProduct">${qna.p_name }</span>
				...
				<tr>
					...
					<td>
						<pre><textarea id="InputTextarea" name="q_content" cols="5" rows="1" placeholder="문의내용을 입력해주세요.(1000자 이내)"
						 style="width:98%;height:280px;">${qna.q_content }</textarea></pre>
						 <br>
			...
			<input type="submit" value="수정하기" class="primary-btn">
		</form>
		</div>
		</div>
    </section>
