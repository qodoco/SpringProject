...
<body>
    ...
    <section>
    	...
    	<form action="faqUpdatePro" method="post">
    		...
    		<div>
    			<input type="text" name="f_title" placeholder="제목을 입력하세요" value="${faq.f_title }" required="required">
    		</div>
    		<div>
    			<select name="q_mcode">
    		...
    		<br>
    		<div>
				<textarea rows="10" cols="100" name="f_content" placeholder="내용을 입력하세요" required="required">${faq.f_content }</textarea>
			</div>
