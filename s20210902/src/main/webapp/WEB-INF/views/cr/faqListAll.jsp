...
<body>
    ...
    <div class="row">
    	...
    	<ul>
    		...
    		<li><a href="faqListAll?q_mcode=310">상품</a></li>
    	...
    	<div class="shopping__cart__table">
    		...
    		<c:if test="${total == 0 }">
    			<div style="padding: 30px;border-top: 1px solid #5555;">내역이 없습니다.</div>
    		</c:if>
			<c:if test="${total > 0 }">    		
    			...
    			<%-- <li id="faqListId${cnt}" class="faqHide" style="border-top: 1px solid gray;"> --%>
    				...
    				<div class="title${cnt }" onclick="faqList(${cnt})" style="padding: 30px;border-top: 1px solid #5555;">
							<span class="cate" style="padding-right: 15%; font-weight: bold; width: 250px;">${faq.content }</span>
							<span class="title2" style="font-style: ">${faq.f_title }</span>
					</div>
					<div class="content" style="display: none; padding :30px; background-color: #F6F6F6;">
    	...
    	<div class="product__pagination">
			...
			<c:forEach var="i" begin="${page.startPage }" end="${page.endPage }">
				<a href="faqListAll?q_mcode=${faq.q_mcode }&currentPage=${i }" class="<c:if test="${page.currentPage == i }">active</c:if>">${i }</a>
			</c:forEach>
