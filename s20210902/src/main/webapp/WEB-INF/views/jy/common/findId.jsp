...
<%@ include file="/WEB-INF/views/jy/cm/managerHeader.jsp" %>
    ...
    <section class="breadcrumb-option">
    	...
    	<div class="container">
    <form id="findId" style="margin: 5%">
		<div class="register" style="padding: 16px; background-color: white; width: 60%; margin: -10px auto; ">
    	<h3 style="width: 100%;	position: relative; border-bottom:2px solid black; padding:8px 0;">아이디 찾기</h3>
			<hr>

			<label for="name"><b>이름</b></label> 
			<input class="input_find" type="text" name="mem_name" id="mem_name" required="required" placeholder="Name" />
			<label for="email"><b>이메일</b></label> 
			<input class="input_find" type="text" name="mem_email" id="mem_email" required="required" placeholder="Email" />
			<label for="phone"><b>전화번호</b></label> 
			<input class="input_find" type="text" name="mem_tel" id="mem_tel" required="required" placeholder="Phone" />

			<hr>
			<p>
				you agree to our <a href="#">Terms & Privacy</a>.
			</p>
			<button class="jybutton" onclick="javascript:fn_btnFindIdClick(); return false;" style="margin-left: 38.5%">확인</button>
	...
	<form id="goHome" action="${contextPath}/home" method="post">
	</form>
