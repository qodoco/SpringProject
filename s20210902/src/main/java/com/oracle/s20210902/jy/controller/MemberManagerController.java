...
public class MemberManagerController {
	...
	@RequestMapping(value = "mng/updateForm")
	public String updateForm(int mem_no, Model model) {
		System.out.println("MemberController updateForm Start");
		Member member = ms.userDetail(mem_no);
		model.addAttribute("member", member);
		
		return "jy/manager/updateForm";
	}
	
	@PostMapping(value = "mng/update")
	public String update(Member member, Model model) {
		System.out.println("MemberManager update Start");
