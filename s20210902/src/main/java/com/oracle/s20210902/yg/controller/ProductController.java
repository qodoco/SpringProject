...
//		model.addAttribute("admin", admin);
	...
	public String productDelete(Product product,HttpServletRequest request, String deleteFileName, Model model) {
		...
		System.out.println("ProductController productDelete getP_img --->"+product.getP_img());
       
		int fileDelResult = upFileDelete(deleteFileName1); 
		System.out.println("ProductController productDelete fileDelResult --->"+fileDelResult);
